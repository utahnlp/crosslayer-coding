# %% [markdown]
# # Tutorial 7: GPT-2 Hyperparameter Sweep (Norm=None, Part 1)
#
# This tutorial demonstrates splitting a hyperparameter sweep across multiple scripts.
# This script focuses on training GPT-2 CLTs with `normalization_method="none"` and the first
...
try:
    ...
    # ActivationGenerator not needed as we don't generate/verify norm stats here
...
# Assumes activations were generated with these settings
...
activation_config = ActivationConfig(
    ...
    # compute_norm_stats=False, # Not required for norm=none
)
...
#
# Check if the core activation files (`metadata.json`, `index.bin`) exist.
# `norm_stats.json` is *not* required for `normalization_method="none"`.
...
# %% [markdown]
# ## 4. Hyperparameter Sweep (Norm=None, Part 1)
#
...
print("\nStarting Hyperparameter Sweep (GPT-2, Norm=None, Part 1)...")
...
# %%
print("\nHyperparameter Sweep (GPT-2, Norm=None, Part 1) Complete!")
