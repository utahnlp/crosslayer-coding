# %% [markdown]
# # Tutorial 7: GPT-2 Hyperparameter Sweep (Local Manifest, Norm=None, Part 1)
#
...
# %% [markdown]
# ## 4. Hyperparameter Sweep (Local Manifest, Norm=None, Part 1)
#
...
# %%
# --- Argument Parsing ---
parser = argparse.ArgumentParser(description="Run part 1 of GPT-2 CLT hyperparameter sweep with norm=none.")
