# %% [markdown]
# # Tutorial 6: GPT-2 Hyperparameter Sweep (Norm=Auto, Part 2)
#
...
# %% [markdown]
# ## 4. Hyperparameter Sweep (Norm=Auto, Part 2)
#
...
print("\nStarting Hyperparameter Sweep (GPT-2, Norm=Auto, Part 2)...")
...
# %%
print("\nHyperparameter Sweep (GPT-2, Norm=Auto, Part 2) Complete!")
