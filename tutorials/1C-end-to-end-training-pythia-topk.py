...
topk_k_val = 500  # Can be a float for fraction or int for count
...
training_config = TrainingConfig(
    ...
    sparsity_lambda=0.001,  # Standard sparsity penalty (adjust as needed for TopK)
    sparsity_lambda_schedule="linear",
    sparsity_c=1.0,  # Standard sparsity penalty (adjust as needed for TopK)
