...
activation_dir = "./tutorial_activations_local_1M_pythia_160m"  # Point back to original activations
...
training_config = TrainingConfig(
    ...
    preactivation_coef=0.0,  # Disable preactivation loss (AuxK handles dead latents)
