# %% [markdown]
# # Tutorial 6: GPT-2 Hyperparameter Sweep (Local Manifest, Norm=Auto, Part 1)
#
...
# %% [markdown]
# ## 4. Hyperparameter Sweep (Local Manifest, Norm=Auto, Part 1)
#
...
# %%
# --- Argument Parsing ---
parser = argparse.ArgumentParser(description="Run part 1 of GPT-2 CLT hyperparameter sweep with norm=auto.")
...
print("\nStarting Hyperparameter Sweep (GPT-2, Local Manifest, Norm=Auto, Part 1)...")
...
for sc in sparsity_c_values:
    for sl in sparsity_lambda_values:
        run_counter += 1  # Increment counter at the start of each combination
        ...
        try:
            ...
            try:
                ...
                traceback.print_exc()  # Print traceback for wandb cache deletion warning
            if device == "cuda":
...
# %%
print(f"\nHyperparameter Sweep (GPT-2, Local Manifest, Norm=Auto, Part 1) Complete!")
